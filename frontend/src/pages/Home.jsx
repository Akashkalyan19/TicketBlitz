    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="glass-card p-8 max-w-md text-center">
          ...
          <button
            onClick={() => { setLoading(true); setError(''); fetchEvents(); }}
      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Experience seamless, concurrent-safe seat booking. Our system handles thousands of simultaneous requests without any race conditions.
          </p>
        </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-emerald-400">{event.available_seats}</div>
                      <div className="text-xs text-slate-500 uppercase tracking-wider">Available</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-amber-400">{event.held_seats}</div>
                      <div className="text-xs text-slate-500 uppercase tracking-wider">Held</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-red-400">{event.booked_seats}</div>
                      <div className="text-xs text-slate-500 uppercase tracking-wider">Booked</div>
                    </div>
                    
                    {/* Arrow */}
                    <div className="hidden md:block">
                      <svg className="w-6 h-6 text-slate-400 group-hover:text-indigo-400 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          <div className="glass-card p-6 text-center">
            ...
            <p className="text-sm text-slate-400">Handles concurrent requests with zero race conditions</p>
          </div>
          ...
          <div className="glass-card p-6 text-center">
            ...
            <p className="text-sm text-slate-400">Idempotent payment processing prevents double charges</p>
          </div>
          ...
          <div className="glass-card p-6 text-center">
            ...
            <p className="text-sm text-slate-400">Held seats automatically release after 10 minutes</p>
          </div>
        </div>
      </div>
    </div>
